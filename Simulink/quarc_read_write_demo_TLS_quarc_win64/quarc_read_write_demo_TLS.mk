###########################################################################
## Makefile generated for component 'quarc_read_write_demo_TLS'. 
## 
## Makefile     : quarc_read_write_demo_TLS.mk
## Generated on : Thu Oct 16 10:37:06 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\quarc_read_write_demo_TLS.rt-win64
...
PRODUCT_NAME              = quarc_read_write_demo_TLS
MAKEFILE                  = quarc_read_write_demo_TLS.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\tst2753\Documents\ControlEngineering_TLS\Demos
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = quarc_read_write_demo_TLS_comp.rsp
CMD_FILE                  = quarc_read_write_demo_TLS.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\quarc_read_write_demo_TLS.rt-win64
...
DEFINES_STANDARD = -DMODEL=quarc_read_write_demo_TLS -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS.c $(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS_data.c $(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS_main.c $(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rtGetInf.c $(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rtGetNaN.c $(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = quarc_read_write_demo_TLS.obj quarc_read_write_demo_TLS_data.obj quarc_read_write_demo_TLS_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
quarc_read_write_demo_TLS.obj : "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS.c"


quarc_read_write_demo_TLS_data.obj : "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS_data.c"


quarc_read_write_demo_TLS_main.obj : "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\quarc_read_write_demo_TLS_main.c"


rtGetInf.obj : "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\quarc_read_write_demo_TLS_quarc_win64\rt_nonfinite.c"
