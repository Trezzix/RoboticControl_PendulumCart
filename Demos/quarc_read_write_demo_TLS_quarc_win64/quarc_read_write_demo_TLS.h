...
#ifndef RTW_HEADER_quarc_read_write_demo_TLS_h_
#define RTW_HEADER_quarc_read_write_demo_TLS_h_
#ifndef quarc_read_write_demo_TLS_COMMON_INCLUDES_
#define quarc_read_write_demo_TLS_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                          /* quarc_read_write_demo_TLS_COMMON_INCLUDES_ */

#include "quarc_read_write_demo_TLS_types.h"
...
#define quarc_read_write_demo_TLS_rtModel RT_MODEL_quarc_read_write_dem_T

/* Block signals (default storage) */
typedef struct {
  real_T ManualSwitch;                 /* '<Root>/Manual Switch' */
  real_T cart_pos_mm;                  /* '<Root>/[m] to [mm]' */
  real_T Gain;                         /* '<S2>/Gain' */
  real_T out;                          /* '<Root>/safety_envelope' */
} B_quarc_read_write_demo_TLS_T;
...
typedef struct {
  ...
  real_T t0;                           /* '<Root>/safety_envelope' */
...
} DW_quarc_read_write_demo_TLS_T;

/* Backward compatible GRT Identifiers */
#define rtB                            quarc_read_write_demo_TLS_B
#define BlockIO                        B_quarc_read_write_demo_TLS_T
#define rtP                            quarc_read_write_demo_TLS_P
#define Parameters                     P_quarc_read_write_demo_TLS_T
#define rtDWork                        quarc_read_write_demo_TLS_DW
#define D_Work                         DW_quarc_read_write_demo_TLS_T

/* Parameters (default storage) */
struct P_quarc_read_write_demo_TLS_T_ {
  ...
  int32_T HILInitialize1_POModes;  /* Computed Parameter: HILInitialize1_POModes
                                    * Referenced by: '<Root>/HIL Initialize1'
                                    */
  uint32_T HILInitialize1_AIChannels[2];
                                /* Computed Parameter: HILInitialize1_AIChannels
                                 * Referenced by: '<Root>/HIL Initialize1'
                                 */
  uint32_T HILInitialize1_AOChannels[2];
                                /* Computed Parameter: HILInitialize1_AOChannels
                                 * Referenced by: '<Root>/HIL Initialize1'
                                 */
  uint32_T HILInitialize1_EIChannels[2];
...
struct tag_RTM_quarc_read_write_demo_T {
  const char_T *path;
...
extern P_quarc_read_write_demo_TLS_T quarc_read_write_demo_TLS_P;

/* Block signals (default storage) */
extern B_quarc_read_write_demo_TLS_T quarc_read_write_demo_TLS_B;

/* Block states (default storage) */
extern DW_quarc_read_write_demo_TLS_T quarc_read_write_demo_TLS_DW;

/* Model entry point functions */
extern void quarc_read_write_demo_TLS_initialize(void);
extern void quarc_read_write_demo_TLS_output(void);
extern void quarc_read_write_demo_TLS_update(void);
extern void quarc_read_write_demo_TLS_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern quarc_read_write_demo_TLS_rtModel *quarc_read_write_demo_TLS(void);
...
extern RT_MODEL_quarc_read_write_dem_T *const quarc_read_write_demo_TLS_M;
 ...
 *
 * '<Root>' : 'quarc_read_write_demo_TLS'
 * '<S1>'   : 'quarc_read_write_demo_TLS/Quanser'
 * '<S2>'   : 'quarc_read_write_demo_TLS/[rad] to [deg]'
 * '<S3>'   : 'quarc_read_write_demo_TLS/safety_envelope'
 */
#endif                             /* RTW_HEADER_quarc_read_write_demo_TLS_h_ */
